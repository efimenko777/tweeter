...
var i = document.body.addEventListener('submit', function (event) {
  event.preventDefault();
  var form = document.querySelector('textarea');
  app(form.value);
  form.value = "";
});
},{"./app.js":"app.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
